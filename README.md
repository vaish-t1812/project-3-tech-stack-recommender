...
Ask the user to enter their skills.
Validate the user input.
Convert career skills and user skills into TF-IDF vectors.
Calculate cosine similarity between the user and each career.
Sort careers according to their similarity scores.
Display the top three career recommendations.
Technologies Used
Python
Pandas
Scikit-learn
